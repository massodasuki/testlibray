...
public class WebActivity extends AppCompatActivity {
    ...
    void processValue(String result) throws JSONException {
        ...
        Toast.makeText(
                this, getString(R.string.payments_show_name, result),
        ...
        String requestURL = responseObj.getJSONObject("TxnData")
                .getString("RequestData");
        String requestData = responseObj.getJSONObject("TxnData")
                                        .getString("RequestData");
        ...
        requestURL = "https://www.onlinepayment.com.my/RMS/CardScheme/loading.php";
